...
void ofApp::setup(){
    ...
    unsigned int numHiddenNeurons = 8; //For more complex problems, increase the number of hidden units
    ...
    mlp.setMaxNumEpochs( 10000 ); //This sets the maximum number of epochs (1 epoch is 1 complete iteration of the training data) that are allowed
